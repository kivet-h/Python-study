...
# 终端执行：$ python -m unittest mydict_test
# .....
# ----------------------------------------------------------------------
...
# 终端执行:$ python -m unittest mydict_test.TestDict.test_attr
# .
# ----------------------------------------------------------------------
...
# 终端执行:$ python -m unittest mydict_test -k attr -v
