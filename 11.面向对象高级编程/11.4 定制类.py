...
#         self.name = name
#
# print(Student('Michael')) # ==> <__main__.Student object at 0x000001ACB8750830>
...
# 如果不用print，而是直接在Python控制台中，打印出来的实例还是不好看的格式：
# >>> s = Student('Michael')
# >>> s
...
#   File "D:\web\python-study-ljf\11.面向对象高级编程\11.4 定制类.py", line 129, in <module>
#     print(Fib()[5])
#           ~~~~~^^^
...
# print(s.score) # ==> 报错：AttributeError: 'Student' object has no attribute 'score'
...
# # 调用方式如下：
# s = Student('Michael')
# s() # ==> My name is Michael.   # self参数不要传入
...
# 本节介绍的是最常用的几个定制方法，还有很多可定制的方法，请参考Python的官方文档:https://docs.python.org/zh-cn/3.14/reference/datamodel.html#special-method-names