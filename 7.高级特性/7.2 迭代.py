...
# 而很多语言比如C语言，迭代list是通过下标完成的，比如C代码：
# L = ['a', 'b', 'c', 'd']
...
# 这是因为dict的存储不是按照list的方式顺序排序的，所以迭代出来的结果顺序可能不一样。
...
# for x, y, z in [(1, 5, 15), (2, 6, 26), (3, 7, 37)]:
#     print(x, y, z)
# # ==>
# # 1 5 15
# # 2 6 26
...
# for x, y, z in [(1, 5, 15), (2, 6), (3, 7)]:
#     print(x, y, z)
# ==>
# 能打印出1 5 15
# 剩下的报错

# for x, y in [(1, 5, 15), (2, 6), (3, 7)]:
#     print(x, y)
# ==>
# 直接报错