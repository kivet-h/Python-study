...
# print(obj.y) # ==> 报错: AttributeError: 'MyObject' object has no attribute 'y'
...
# print(getattr(obj, 'z')) # ==> 报错：AttributeError: 'MyObject' object has no attribute 'z'
...
#
# # 获取属性'power'
# print(getattr(obj, 'power')) # ==> <bound method MyObject.power of <__main__.MyObject object at 0x0000026663540830>>
#
# # 获取属性'power'并赋值到变量fn
# fn = getattr(obj, 'power')
# # fn指向obj.power
# print(fn) # ==> <bound method MyObject.power of <__main__.MyObject object at 0x0000018C9C4DC830>>
#
